...
// Ambil data izin yang ditolak
$sql = "SELECT * FROM izin WHERE status = 'rejected' ORDER BY id DESC";
...
<head>
    ...
    <style>
        body {
            ...
            margin-top: 0; /* Menghapus margin-top agar navbar lebih ke atas */
        }
...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="container mt-5">
        <!-- Box untuk kedua judul "Izin Ditolak" dan "Data Izin yang Telah Ditolak" -->
        <div class="box-title">
            Izin Ditolak - Data Izin yang Telah Ditolak
        </div>
                ...
                <tbody>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><?php echo ($row['status'] == 'rejected') ? 'Izin Ditolak' : 'Izin Diterima'; ?></td>
                            <td>
        ...
        <?php else: ?>
            <p class="text-center">Belum ada izin yang ditolak.</p>
        <?php endif; ?>
    </div>
